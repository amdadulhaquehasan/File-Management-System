    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TotalStorageUsed = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecommendationAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    FileId = table.Column<Guid>(type: "uuid", nullable: false),
                    PermissionLevel = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, defaultValue: "read"),
                    SharedWithUserId = table.Column<Guid>(type: "uuid", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangeSummary = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrashBin", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrashBin_Files_FileId",
                        column: x => x.FileId,
                        principalSchema: "dbo",
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrashBin_Users_DeletedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrashBin_DeletedBy",
                schema: "dbo",
                table: "TrashBin",
                column: "DeletedBy");

            migrationBuilder.CreateIndex(
                name: "IX_TrashBin_FileId",
                schema: "dbo",
                table: "TrashBin",
                column: "FileId");
        }
